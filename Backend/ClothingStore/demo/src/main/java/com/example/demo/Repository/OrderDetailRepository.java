...
public interface OrderDetailRepository extends JpaRepository<OrderDetail, Long> {
    ...
    @Query("SELECT new com.example.demo.DTO.OrderDetailReturnDTO(p.id, o.id, od.numberOfProduct, od.totalMoney, p.productName, pi.imageUrl, o.users.address, o.orderDate, o.status) " +
            "FROM Orders o " +
