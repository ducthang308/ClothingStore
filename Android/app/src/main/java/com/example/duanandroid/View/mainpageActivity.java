...
public class mainpageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView = binding.bottomNavigationView; // Đảm bảo rằng BottomNavigationView tồn tại trong XML
        ...
        viewPager.setCurrentItem(tabPosition);  // Đặt vị trí tab hiện tại

        viewPager.setCurrentItem(2);  // Vị trí 2 là Home (0-based index)
        // Đặt tab "Home" được chọn mặc định
        bottomNavigationView.setSelectedItemId(R.id.menu_home);
        // Lắng nghe sự thay đổi của ViewPager để cập nhật BottomNavigationView tương ứng
        ...
        // Xử lý khi người dùng chọn mục trên BottomNavigationView
