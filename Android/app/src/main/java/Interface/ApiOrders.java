...
public interface ApiOrders {
    ...
    @GET("api/v1/orders")
    Call<List<OrdersDTO>> getAllOrders(@Header("Authorization") String token);
    ...
    Call<String> updateOrderStatus(@Header("Authorization") String token, @Path("id") int id, @Body OrdersDTO orderDTO);
}
