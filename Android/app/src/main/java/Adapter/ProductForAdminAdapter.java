...
public class ProductForAdminAdapter extends RecyclerView.Adapter<ProductAdapter.ProductViewHolder> {
    ...
    // Constructor
    public ProductForAdminAdapter(List<Product> productList, List<ProductImage> productImageList) {
